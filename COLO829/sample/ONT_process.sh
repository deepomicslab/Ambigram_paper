...
# simulate Nanopore (ONT) sequencing
# para:
# 1: input fasta
# 2: prefix
# 3: depth/coverage
function ONT_simulation()
{
    pbsim --prefix $2 --depth $3 --hmm_model ~/pbsim2/data/R103.model $1
}

# alignment for ONT reads 
# para:
# 1: fastq file
# 2: prefix
# 3: reference fasta
function ONT_alignment()
{
    ngmlr -t 16 -r $3 -q $1 -o ${2}.sam -x ont
...
# example
call_sv ONT.bam ONT 30 5 200
get_sv ONT.vcf ONT
generate_lh ONT_sv.txt ../COLO829_1_seg.txt sample1_ONT 1
find_BFB sample1_ONT.1.lh sample1